...
Register-ArgumentCompleter -Native -CommandName 'tio' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'tio' {
            ...
            [CompletionResult]::new('capture', 'capture', [CompletionResultType]::ParameterValue, 'Trigger and read a capture RPC')
            ...
            [CompletionResult]::new('simulate', 'simulate', [CompletionResultType]::ParameterValue, 'Run a simulated sine wave Twinleaf device over UDP')
            [CompletionResult]::new('test', 'test', [CompletionResultType]::ParameterValue, '(deprecated, use `simulate`) Run a simulated sine wave Twinleaf device over UDP')
        ...
        'tio;log;csv' {
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 'Sensor route in the device tree (default: /); overridden by a route prefix in the selector')
            [CompletionResult]::new('-o', '-o', [CompletionResultType]::ParameterName, 'Output filename prefix')
            [CompletionResult]::new('-f', '-f', [CompletionResultType]::ParameterName, 'Overwrite the output file if it already exists')
            [CompletionResult]::new('--force', '--force', [CompletionResultType]::ParameterName, 'Overwrite the output file if it already exists')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        ...
        'tio;capture' {
            ...
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 'Sensor path in the sensor tree')
            [CompletionResult]::new('--sensor', '--sensor', [CompletionResultType]::ParameterName, 'Sensor path in the sensor tree')
            [CompletionResult]::new('--timeout', '--timeout', [CompletionResultType]::ParameterName, 'Maximum time to wait for capture data')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
        'tio;upgrade' {
            ...
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 'Sensor path in the sensor tree')
            [CompletionResult]::new('--sensor', '--sensor', [CompletionResultType]::ParameterName, 'Sensor path in the sensor tree')
            [CompletionResult]::new('--downgrade', '--downgrade', [CompletionResultType]::ParameterName, 'List all published firmware for the connected sensor and interactively pick one to install (allows installing an older release)')
        ...
        'tio;proxy' {
            [CompletionResult]::new('--mount', '--mount', [CompletionResultType]::ParameterName, 'Mount a sensor at a route prefix to multiplex multiple devices (repeatable)')
            ...
            [CompletionResult]::new('-t', '-t', [CompletionResultType]::ParameterName, 'Deprecated; timestamps are now emitted by the logger (set RUST_LOG to control verbosity)')
            [CompletionResult]::new('--timestamp', '--timestamp', [CompletionResultType]::ParameterName, 'Deprecated; timestamps are now emitted by the logger (set RUST_LOG to control verbosity)')
        ...
        'tio;completions' {
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 'Generate static instead of dynamic completions')
            [CompletionResult]::new('--static', '--static', [CompletionResultType]::ParameterName, 'Generate static instead of dynamic completions')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('-V', '-V ', [CompletionResultType]::ParameterName, 'Print version')
            [CompletionResult]::new('--version', '--version', [CompletionResultType]::ParameterName, 'Print version')
